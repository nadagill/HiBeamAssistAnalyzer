...
#if 1 // SYNERGYS : HBA GPIO MUX
    TI816X_MUX(SC1_RST, OMAP_MUX_MODE2),        /* gpio0-22 */
    TI816X_MUX(SC1_VPPEN, OMAP_MUX_MODE2),      /* gpio0-27 */
    TI816X_MUX(SC0_CLK, OMAP_MUX_MODE2),        /* gpio1-11 */
    TI816X_MUX(SC0_DATA, OMAP_MUX_MODE2),       /* gpio1-12 */
    TI816X_MUX(SC0_C4, OMAP_MUX_MODE1),         /* gpio1-13 */
    TI816X_MUX(SC0_VCCEN, OMAP_MUX_MODE2),      /* gpio1-14 */
    TI816X_MUX(UART0_DTRN, OMAP_MUX_MODE3),     /* gpio1-16 */
    TI816X_MUX(UART0_RIN, OMAP_MUX_MODE3),      /* gpio1-19 */
    TI816X_MUX(GPMC_DIR, OMAP_MUX_MODE1),       /* gpio1-20 */
    TI816X_MUX(UART1_CTSN, OMAP_MUX_MODE3),     /* gpio1-26 */
    TI816X_MUX(UART0_RTSN, OMAP_MUX_MODE1),     /* gpio1-27 */
    TI816X_MUX(UART0_CTSN, OMAP_MUX_MODE1),     /* gpio1-28 */
#endif
#if 1 // SYNERGYS : HBA VIDEO INPUT MUX
    TI816X_MUX(VIN0_D0, OMAP_MUX_MODE0),        /* VIN[0]A_D[0] */
    TI816X_MUX(VIN0_D1, OMAP_MUX_MODE0),        /* VIN[0]A_D[1] */
    TI816X_MUX(VIN0_D2, OMAP_MUX_MODE0),        /* VIN[0]A_D[2] */
    TI816X_MUX(VIN0_D3, OMAP_MUX_MODE0),        /* VIN[0]A_D[3] */
    TI816X_MUX(VIN0_D4, OMAP_MUX_MODE0),        /* VIN[0]A_D[4] */
    TI816X_MUX(VIN0_D5, OMAP_MUX_MODE0),        /* VIN[0]A_D[5] */
    TI816X_MUX(VIN0_D6, OMAP_MUX_MODE0),        /* VIN[0]A_D[6] */
    TI816X_MUX(VIN0_D7, OMAP_MUX_MODE0),        /* VIN[0]A_D[7] */
    TI816X_MUX(VIN0_CLK0, OMAP_MUX_MODE0),      /* VIN[0]A_CLK */
    TI816X_MUX(TSI6_BYTSTRT, OMAP_MUX_MODE1),   /* VIN[0]_VSYNC0 */
    TI816X_MUX(TSI6_DATA, OMAP_MUX_MODE1),      /* VIN[0]_HSYNC0 */
#endif
