...
PROJECT_INSTALL_DIR=$(HOME)/project/03.HBA
APPS_INSTALL_DIR=$(PROJECT_INSTALL_DIR)/apps
PLATFORM=dm816x-evm
...
EZSDK_INSTALL_DIR=/home/nadagill/ti-ezsdk
...
CMEM_BUILD_VARS = RULES_MAKE=$(PROJECT_INSTALL_DIR)/Rules.make
...
PSP_INSTALL_DIR=$(PROJECT_INSTALL_DIR)

# The directory that points to your kernel source directory.
LINUXKERNEL_INSTALL_DIR=$(PROJECT_INSTALL_DIR)/kernel
...
APPS_BUILD_VARS = ROOTDIR=$(APPS_INSTALL_DIR) \
                EXTERNAL_SW_ROOT=$(DVSDK_INSTALL_DIR)/component-sources \
                INTERNAL_SW_ROOT=$(APPS_INSTALL_DIR)/src \
        kernel_PATH=${LINUXKERNEL_INSTALL_DIR} \
        bios_PATH=${SYSBIOS_INSTALL_DIR} \
                fc_PATH=$(FC_INSTALL_DIR) \
                osal_PATH=$(OSAL_INSTALL_DIR) \
        ...
        lindevkit_PATH=${LINUX_DEVKIT_DIR}/arm-none-linux-gnueabi/usr \
                PLATFORM=$(OMX_PLATFORM) \
        EXAMPLES_ROOT=${APPS_INSTALL_DIR}/examples \
                CODEGEN_PATH_A8=$(CSTOOL_DIR) \
                CROSS_COMPILE=arm-none-linux-gnueabi- \
                TOOLCHAIN_LONGNAME=arm-none-linux-gnueabi \
        CODEGEN_PATH_DSPELF=${CODEGEN_INSTALL_DIR}
...
CSTOOL_DIR=/home/nadagill/toolchain/armcc/
...
EXEC_DIR=$(PROJECT_INSTALL_DIR)/build
